...
import {
  ...
  TrendingUp, TrendingDown, Bell, ArrowUpRight, Clock, Eye, BarChart3, Package,
} from "lucide-react";
import {
  ...
  return (
    <>
      ...
      <div className="border-b border-[#c9a84c]/10 px-8 py-4 flex items-center justify-between bg-[#0a0a0a]/50 backdrop-blur-sm sticky top-0 z-10">
        <div>
          ...
          <p className="text-[0.7rem] text-[#555]">
            Welcome back, Admin · Kigali time {new Date().toLocaleTimeString("en-RW", { hour: "2-digit", minute: "2-digit" })}
          </p>
        </div>
      ...
      <div className="flex-1 overflow-auto p-8">
        ...
        {/* Recent Orders */}
        <div className="glass-dark border border-[#c9a84c]/10 rounded-sm overflow-hidden mb-6">
